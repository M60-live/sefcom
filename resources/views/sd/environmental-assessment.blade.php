...
<!-- Banner One Start
	====================================================-->
	<div class="page-banner overlay-secondery-8" style="background: url(images/background/ea.png) bottom center/ cover; padding: 150px 0;">
		<div class="container">
			<div class="banner-text text-center">
				<div class="row">
					<div class="col-md-12 col-lg-12">
						<h1 class="position-relative va-c-line-w50-h1-primary pb-15 mb-20 color-white">Environmental Assessment</h1>
						<nav class="breadcrumb-one d-table m-auto bg-white px-30" aria-label="breadcrumb">
						  <ol class="breadcrumb bg-transparent mb-0">
						    <li class="breadcrumb-item"><a href="/">Home</a></li>
						    <li class="breadcrumb-item active" aria-current="page">Environmental Assessment Details</li>
						  </ol>
						</nav>
					</div>
				</div>
				...
				<div class="col-md-12 col-lg-8 col-xl-9">
					<div class="service-details-one">
						<div class="row">
							...
							<div class="col-md-12 col-lg-12">
								<div class="text-area">
									<h3 class="my-30 color-secondery">Environmental Assessment and Data Analysis</h3>
									<p class="mb-15">Sefcom Environmental Consulting (SEC) provides integrated environmental assessment, regulatory advisory, and environmental legal support services to enable responsible project development, regulatory certainty, and defensible decision-making.</p>
									...
									<ul class="pt-2">
										...
										<li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>Legal defensibility review of environmental submissions</li>
