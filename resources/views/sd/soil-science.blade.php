...
<!-- Banner One Start
	====================================================-->
	<div class="page-banner overlay-secondery-8" style="background: url(images/background/Soil-Science.jpg) bottom center/ cover; padding: 150px 0;">
		<div class="container">
			<div class="banner-text text-center">
				<div class="row">
					<div class="col-md-12 col-lg-12">
						<h1 class="position-relative va-c-line-w50-h1-primary pb-15 mb-20 color-white">Soil Science</h1>
						<nav class="breadcrumb-one d-table m-auto bg-white px-30" aria-label="breadcrumb">
						  <ol class="breadcrumb bg-transparent mb-0">
						    <li class="breadcrumb-item"><a href="/">Home</a></li>
						    <li class="breadcrumb-item active" aria-current="page">Soil Science Details</li>
						  </ol>
						</nav>
					</div>
				</div>
				...
				<div class="col-md-12 col-lg-8 col-xl-9">
					<div class="service-details-one">
						<div class="row">
							...
							<div class="col-md-12 col-lg-12">
								<div class="text-area">
									<h3 class="my-30 color-secondery">Soil Science and Land Management</h3>
									...
									<ul class="pt-2">
										...
										<li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>Land capability and agricultural suitability assessment</li>
										<li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>Baseline soil surveys and mapping</li>
										<li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>Closure-aligned land-use planning</li>
                                        <h5 class="color-secondery pt-2">Erosion & Sediment Control</h5>
										<li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>Erosion risk assessments</li>
										...
										<li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>Soil cover thickness optimisation</li>
										<li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>Long-term stability and performance assessment</li>

                                        <h5 class="color-secondery pt-2">Soil Conservation & Rehabilitation Solutions</h5>
										<li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>Practical soil conservation strategies</li>
