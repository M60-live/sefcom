			...
			<div class="banner-text text-center">
				<div class="row">
					<div class="col-md-12 col-lg-12">
						<h1 class="position-relative va-c-line-w50-h1-primary pb-15 mb-20 color-white">Energy & Energy Transition</h1>
						<nav class="breadcrumb-one d-table m-auto bg-white px-30" aria-label="breadcrumb">
						  <ol class="breadcrumb bg-transparent mb-0">
						    <li class="breadcrumb-item"><a href="/">Home</a></li>
						    <li class="breadcrumb-item active" aria-current="page">Energy & Energy Transition Details</li>
						  </ol>
						</nav>
					</div>
				</div>
				...
				<div class="col-md-12 col-lg-8 col-xl-9">
					<div class="service-details-one">
						<div class="row">
							...
							<div class="col-md-12 col-lg-12">
								<div class="text-area">
									<h3 class="my-30 color-secondery">Energy Transition Support and Data Analysis</h3>
									<p class="mb-15">Sefcom Environmental Consulting (SEC) provides integrated advisory and technical services supporting energy development and the global transition toward low-carbon, climate-resilient systems. We work across renewable and conventional energy sectors, helping clients navigate regulatory complexity, environmental risk, water resource constraints, and ESG performance requirements.</p>
									...
									<ul class="pt-2">
										...
										<li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>Rehabilitation and closure strategies</li>
										<li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>Long-term environmental performance monitoring</li>
