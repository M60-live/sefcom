...
<!-- Banner One Start
	====================================================-->
	<div class="page-banner overlay-secondery-8" style="background: url(images/background/em.jpg) bottom center/ cover; padding: 150px 0;">
		<div class="container">
			<div class="banner-text text-center">
				<div class="row">
					<div class="col-md-12 col-lg-12">
						<h1 class="position-relative va-c-line-w50-h1-primary pb-15 mb-20 color-white">Environmental Monitoring Equipment Supply</h1>
						<nav class="breadcrumb-one d-table m-auto bg-white px-30" aria-label="breadcrumb">
						  <ol class="breadcrumb bg-transparent mb-0">
						    <li class="breadcrumb-item"><a href="/">Home</a></li>
						    <li class="breadcrumb-item active" aria-current="page">Environmental Monitoring Equipment Supply Details</li>
						  </ol>
						</nav>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-md-12 col-lg-12">
								<div class="owl-carousel service-slider owl-nav-style-one position-relative">
									<img src="images/services/Environmental Monitoring Equipment Supply Page.png" alt="images">
							...
							<div class="col-md-12 col-lg-12">
								<div class="text-area">
									<h3 class="my-30 color-secondery">Environmental Monitoring Equipment Supply and Installations</h3>
									<p class="mb-15">Sefcom Environmental Consulting (SEC) provides integrated supply, installation, and technical support for advanced environmental and scientific measurement systems.</p>
									...
									<ul class="pt-2">
                                        ...
                                        <li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>Cloud-based data acquisition platforms</li>
                                        <li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>Environmental monitoring software deployment</li>
                                        <li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>Real-time compliance dashboards</li>
                                        <li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>ESG-aligned reporting integration</li>

                                        <h5 class="color-secondery pt-2">Installation & Technical Support</h5>
										<li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>Technical specification and procurement advisory</li>
										<li><i class="bi bi-bullseye pr-2" style="color:#4BAF47;"></i>On-site installation and commissioning</li>
