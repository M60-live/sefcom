...
@section('content')
			...
			<div class="banner-text text-center">
				<div class="row">
					<div class="col-md-12 col-lg-12">
						<h1 class="position-relative va-c-line-w50-h1-primary pb-15 mb-20 color-white">Power BI Development & Executive Dashboards</h1>
						<nav class="breadcrumb-one d-table m-auto bg-white px-30" aria-label="breadcrumb">
						  <ol class="breadcrumb bg-transparent mb-0">
						    <li class="breadcrumb-item"><a href="/">Home</a></li>
						    <li class="breadcrumb-item active" aria-current="page">Power BI Development & Executive Dashboards</li>
						  </ol>
						</nav>
					</div>
				</div>
    ...
    <div class="py-80">
		<div class="container">
			<div class="row">
                <h2 class="color-secondery pb-2">Power BI Development & Executive Dashboards</h2>
                <ul>
